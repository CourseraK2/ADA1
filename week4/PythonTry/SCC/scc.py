...
'''
    Download the text file here[http://spark-public.s3.amazonaws.com/algo1/programming_prob/SCC.txt]. Zipped version here[http://spark-public.s3.amazonaws.com/algo1/programming_prob/SCC.zip]. (Right click and save link as)
